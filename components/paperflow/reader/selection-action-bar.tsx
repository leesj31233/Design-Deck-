...
export function SelectionActionBar({ anchor, onHighlight, onNote, onCopy, onShell, onDismiss, saving }: { anchor: TextAnchor; onHighlight: (color: AnnotationColor) => void; onNote: () => void; onCopy: () => void; onShell: (name: string) => void; onDismiss: () => void; saving: boolean }) {
